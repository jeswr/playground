const df_299_0 = new (require('@comunica/logger-void').LoggerVoid)();
...
const df_629_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_629_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize_Bus_RdfSerialize
});
const df_629_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const df_625_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_625_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const df_625_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'df_625_1',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_myRdfSparqlSerializer = new (require('@comunica/actor-sparql-serialize-rdf').ActorSparqlSerializeRdf)({
  ...
  'mediatorMediaTypeCombiner': df_629_0,
  'mediatorMediaTypeFormatCombiner': df_629_1,
...
const urn_comunica_sparqlinit = new (require('@comunica/actor-init-sparql').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': df_625_0,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': df_625_1,
